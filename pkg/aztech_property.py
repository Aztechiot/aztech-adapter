...
from pyKyla import SmartDeviceException

from .util import hsv_to_rgb, rgb_to_hsv


class AztechProperty(Property):
    """Aztech property type."""
...
class AztechPlugProperty(AztechProperty):
    """Property type for Aztech smart plugs."""
...
class AztechBulbProperty(AztechProperty):
    """Property type for Aztech smart bulbs."""
